...
int image_demo(NanoDet &detector, const char* imagepath)
{
    ...
    for (auto img_name : filenames)
    {
        ...
        detector.detect(resized_img, results);
            ...
            std::string save_path = "/home/giapvn/workspace/awl/DemoNanodetMNN/results/";
...
int main(int argc, char** argv)
{
    ...
    NanoDet detector = NanoDet("/home/giapvn/Downloads/nanodet-plus-m_416_mnn.mnn", 416, 416, 4, 0.45, 0.3);
